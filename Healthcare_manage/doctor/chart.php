...
$yearQuery = "SELECT DISTINCT YEAR(appointment_date) AS year FROM appointments WHERE doctor_id = $did ORDER BY year ASC";
...
$dailyQuery = "SELECT DATE(appointment_date) AS day, COUNT(*) AS total FROM appointments WHERE doctor_id = $did GROUP BY DATE(appointment_date)";
...
$weeklyQuery = "SELECT YEARWEEK(appointment_date) AS week, COUNT(*) AS total FROM appointments WHERE doctor_id = $did GROUP BY YEARWEEK(appointment_date)";
...
foreach ($years as $year) {
    $monthlyQuery = "SELECT MONTH(appointment_date) AS month, COUNT(*) AS total FROM appointments WHERE YEAR(appointment_date) = $year AND doctor_id = $did GROUP BY MONTH(appointment_date)";
