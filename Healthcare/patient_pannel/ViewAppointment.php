...
$query3 = mysqli_query($conn, "SELECT * FROM appointments WHERE patient_id=$pid");
...
<head>
    ...
    <script>
                ...
                dateInput.addEventListener("change", function() {
                    ...
                    if (selectedDate > maxAllowedDate) {
                        Swal.fire({
                            ...
                            text: "Appointments can only be scheduled within the next 30 days. Please choose a date within this timeframe.",
                            confirmButtonText: "Got it, I'll choose another date",
                        });
        ...
        function validationForm() {
            ...
            let timeSlots = document.getElementById('timeSlots').value.trim();
            ...
            if (timeSlots == "-- Select Time --") {
                ...
                setTimeout(() => {
                    document.getElementById("ttval").style.display = "none";
                }, 1200);
                ...
                <form method="post" onsubmit="return validationForm()">
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <span id="dtval" class="text-danger" style="display: none;"> * Date is required.
                            </span>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="reason" class="form-control" value="<?= $upreason ?>" name="reason">
