...
$data = [
    ...
    "order_meta" => [
        "return_url" => "http://localhost/Online_Healthcare_Appointment_System/Healthcare/Healthcare/patient_pannel/cashfree_payment/callback.php?order_id={$order_id}&patient_id={$patient_id}"
    ]
];
...
if (isset($response['payment_link'])) {
    ...
    echo "<script>
        ...
        }).then(() => { window.location.href = 'addappointment.php'; });
    </script>";
    exit();
}
