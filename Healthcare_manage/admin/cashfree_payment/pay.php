...
$data = [
    ...
    "order_meta" => [
        "return_url" => "http://localhost/Online_Healthcare_Appointment_System/Healthcare/Healthcare_manage/admin/cashfree_payment/callback.php?order_id={$order_id}&patient_id={$patient_id}"
    ]
];
