...
$query3 = mysqli_query($conn, "SELECT p.patient_id, p.patient_name, p.dob, p.contact,p.email, COUNT(a.appoint_id) AS total_appointments FROM patients p JOIN appointments a ON p.patient_id = a.patient_id WHERE a.doctor_id = $did GROUP BY p.patient_id");
?>
                                    ...
                                    <div class="modal-content shadow-lg rounded-4">
                                        ...
                                        <div class="modal-header bg-primary text-white">
                                            <h5 class="modal-title fw-bold">
                                                <i class="bi bi-calendar-check"></i> Doctor - Appointment Details: <?= $patient["patient_name"] ?>
                                            </h5>
                                        ...
                                        <div class="modal-body p-4">
                                            <div class="container-fluid">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <h5 class="fw-bold text-primary mb-3">
                                                            <i class="bi bi-clock-history"></i> Appointment History (Doctor)
                                                        </h5>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    $appointments = mysqli_query($conn, "SELECT * FROM appointments WHERE patient_id = $p_id AND doctor_id = $did");
