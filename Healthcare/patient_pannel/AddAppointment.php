...
$pname = $_SESSION["user"];
$query10 = mysqli_query($conn, "SELECT * FROM patients WHERE username = '$pname'");
    ...
    <script>
        function validationForm() {
            ...
            function showError(elementId) {
                ...
                setTimeout(() => errorElement.style.display = "none", 1200);
            }
            ...
            if (timeSlot == "-- Select Time --") { // Instead of "Select Time", checking if empty
                showError("timeval"); // Ensure you have an element with `id="timeval"`
                isValid = false;
            }
...
<body>
    ...
    <div class="content">
        ...
        <div class="header-list">
            <div class="left pt-4">
                <h4 class="fw-bold">Book New Appointment</h4>
                <p style="margin-top:10px;"><a href="./Dashboard.php"> HealthCare </a> > <a
                        href="./ViewAppointment.php"> Appointments </a> > <span> Book Appointment </span></p>
            </div>
        </div>
            ...
            <div class="form-container">
                <form action="./cashfree_payment/pay.php" onsubmit="return validationForm()" method="post">
                    <div class="form-group">
                        ...
                        <?php $patient1 = mysqli_fetch_assoc($query10); ?>
                        <select name="patient_name" id="patient_name" class="form-select">
                            <option value="<?= $patient1["patient_id"] ?>"><?= $patient1["patient_name"] ?></option>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <span id="dtval" style="color:red;display:none;"> * Time is Required </span>
                    </div>
                    <div class="form-group">
