...
$yearQuery = "SELECT DISTINCT YEAR(appointment_date) AS year FROM appointments ORDER BY year ASC";
...
$dailyQuery = "SELECT DATE(appointment_date) AS day, COUNT(*) AS total FROM appointments GROUP BY DATE(appointment_date)";
...
$weeklyQuery = "SELECT YEARWEEK(appointment_date) AS week, COUNT(*) AS total FROM appointments GROUP BY YEARWEEK(appointment_date)";
...
foreach ($years as $year) {
    $monthlyQuery = "SELECT MONTH(appointment_date) AS month, COUNT(*) AS total FROM appointments WHERE YEAR(appointment_date) = $year GROUP BY MONTH(appointment_date)";
...
<body>
    <div class="container mt-4">
        <h2 class="text-center mb-4"><i class="fas fa-chart-line text-primary"></i> Appointment Statistics </h2>
    ...
    <script>
        ...
        gradient.addColorStop(0, 'rgba(54, 162, 235, 0.9)'); // Deep blue at the top
        gradient.addColorStop(1, 'rgba(68, 0, 255, 0.9)'); // Teal at the bottom
        ...
        let chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    hoverBackgroundColor: "rgba(36, 131, 155, 0.8)", // Highlight effect on hover
