                    ...
                    <tbody>
                        <?php while ($schedule = mysqli_fetch_assoc($query3)) { ?>
                            <tr>
                                ...
                                <td><?php echo implode(", ", json_decode($schedule['available_days'])) ?></td>
                                <td><?php echo $schedule["available_from"]; ?></td>
                                <td><?php echo $schedule["available_to"]; ?></td>
                                <td><?php echo $schedule["appointment_duration"]; ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
