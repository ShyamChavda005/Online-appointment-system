...
<head>
    ...
    <title>UpcomingAppointements</title>
    ...
    <div class="content">
        ...
        <div class="header-list">
            <div class="left pt-4">
                ...
                <p style="margin-top:10px;"><a href="./Dashboard.php"> HealthCare </a> > Appointments ><span> Upcoming
                        Appointments </span></p>
            </div>
            <div class="right">
        ...
        <div class="container">
            <div class="table-container">
                <table id="myTable" class="nowrap">
                    ...
                    <tbody>
                        <?php
                        $query3 = mysqli_query($conn, "SELECT * FROM appointments WHERE (appointment_date > CURDATE() 
        OR (appointment_date = CURDATE() AND appointment_time > CURTIME())) ORDER BY appointment_date ASC, appointment_time ASC");
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if ($appointment["status"] == "Approve") { ?>
                                        <span class="badge bg-success p-2 rounded-pill d-inline-flex align-items-center"
                                            data-bs-toggle="tooltip">
                                            <i class="bi bi-check-circle-fill me-1"></i> Approve
                                        </span>
                                    <?php } else { ?>
                                        <span
                                            class="badge bg-danger text-light p-2 rounded-pill d-inline-flex align-items-center"
                                            data-bs-toggle="tooltip">
                                            <i class="bi bi-clock-fill me-1"></i> Disapprove
                                        </span>
                                    <?php } ?>
                                </td>
                            </tr>
